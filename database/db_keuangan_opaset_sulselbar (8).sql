...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2020 at 06:01 PM
...
INSERT INTO `tb_jurnal` (`id_jurnal`, `nama_jurnal`, `pyd_stat`, `jurnal_id_aset`, `bulan`, `tahun`) VALUES
(9, 'Jurnal Pencatatan 1', 1, 1, 1, 2020);
...
(1, 'Pendapatan lain2', 28, 9),
(2, 'Pendapatan sewa', 12, 9);
...
--
ALTER TABLE `tb_jurnal_transaksi`
  ADD CONSTRAINT `fk_jt_jurnal` FOREIGN KEY (`jt_id_jurnal`) REFERENCES `tb_jurnal` (`id_jurnal`),
  ADD CONSTRAINT `fk_kat_jt` FOREIGN KEY (`jt_id_kategori`) REFERENCES `tb_kategori` (`id_kategori`);
