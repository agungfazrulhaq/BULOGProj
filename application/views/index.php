          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              ...
              <?php foreach($aset as $row_a){?>
                ...
                <li class="nav-item">
                  <a href="<?php echo site_url("Home/showaset/".$row_a->id_aset."/".$curr_month."/".$curr_year);?>" id="namaaset<?php echo $row_a->id_aset;?>" style="border-radius:0px;" class="nav-link black-text"> <?php echo $row_a->nama_aset; ?></a>
                </li>
                <?php }
